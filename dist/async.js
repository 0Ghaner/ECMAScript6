...
function execusaoPrincipal() {
  return _execusaoPrincipal.apply(this, arguments);
}
function _execusaoPrincipal() {
  _execusaoPrincipal = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var resultado;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          promiseComParametros('natan@gmail.com', 123456).then(function (resultado) {
